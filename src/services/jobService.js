...
const { enviarCorreo, enviarEnLote, yaSeEnvio } = require('./emailService');
const { recordatorioDiario, rachaRota, urgenciaActivacion, recuperacionInactividad } = require('../emailTemplates');
