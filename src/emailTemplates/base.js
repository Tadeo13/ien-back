  ...
  <tr>
    <td style="padding:24px 32px;background:${C.white};border-radius:16px 16px 0 0;border-bottom:1px solid ${C.border};">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td>
            <span style="font-family:${FONT.lora};font-size:28px;font-weight:700;color:${C.text};letter-spacing:2px;">IEN<span style="color:${C.gold};font-size:18px;vertical-align:super;">●</span></span>
          </td>
...
module.exports = { C, wrap, header, footer, card, spacer, btn, label, heading, para, muted, signoff };
